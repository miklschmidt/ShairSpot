...
//>>excludeStart('excludeHbs', pragmas.excludeHbs)
  'vendor/requirejs-hbs/hbs/handlebars', 'underscore', 'vendor/requirejs-hbs/hbs/i18nprecompile', 'vendor/requirejs-hbs/hbs/json2'
    ...
    load: function (name, parentRequire, load, config) {
      ...
      function fetchAndRegister(langMap) {
        fetchText(path, function(text) {
          ...
          text = '/* START_TEMPLATE */\n' +
                 'define('+tmplName+"['hbs','vendor/requirejs-hbs/hbs/handlebars'"+depStr+helpDepStr+'], function( hbs, Handlebars ){ \n' +
